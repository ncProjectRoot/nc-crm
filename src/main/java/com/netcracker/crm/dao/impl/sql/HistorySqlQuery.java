...
public final class HistorySqlQuery {
    ...
    public static final String SQL_FIND_HISTORY_BY_ID = "SELECT * FROM history WHERE id = :id;";
    ...
    public static final String SQL_FIND_ALL_HISTORY_BY_DATE = "SELECT id, old_status_id, "
            ...
            + "product_id FROM history WHERE date_change_status = :date_change_status;";
    
    public static final String SQL_FIND_ALL_HISTORY_BY_ORDER_ID = "SELECT * FROM history "
            + "WHERE order_id = :order_id;";
    
    public static final String SQL_FIND_ALL_HISTORY_BY_COMPLAINT_ID = "SELECT * FROM history "
            + "WHERE complaint_id = :complaint_id;";
    
    public static final String SQL_FIND_ALL_HISTORY_BY_PRODUCT_ID = "SELECT * FROM history "
