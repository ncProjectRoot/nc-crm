...
<style>
    ...
    /*
    Order status :
    ·        New - user зробив замовлення, але для його виконання потрібне підтвердження CSR.
    ·        In queue - CSR підтвердив замовлення, і воно поставлене в чергу на  виконання.
    ·        Processing - почався процес фактичного виконання замовлення.
    ·        Active – замовлення виконано, послуга активована і користувач може нею користуватись.
    ·        Disabled – user відключив послугу в своєму особистому кабінеті, і щоб знову її замовити потрібно створити нове замовлення.
    ·        Paused
    */
    ...
    /*
    Product status :
    -    Planned - послуга ще не актуальна(планується, що пізніше компанія буде постачати її) і не доступна для замовлення.
    -    Actual – послуга дійсна і доступна для замовлення.
    -    Outdated – послуга вже не актуальна, застаріла, її не можливо замовити (зберігається в базі для історії та архіву послуг).
    */
